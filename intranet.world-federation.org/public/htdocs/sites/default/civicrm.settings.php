 ...
 *
 */
define( 'CIVICRM_DSN'          , 'mysql://wf_civicrm:wfc1v1crm@localhost/wf_civicrm?new_link=true' );
 ...
 */
define( 'CIVICRM_SITE_KEY', 'wBLvuTgOgQorfMn4hDw0v' );
...
/**
* Setting to disable or enable profile double optin for add to group in profile
