...
<tr>
    ...
    {if !empty($form.address.$blockId.postal_code)}
       <td>
          ...
          <SCRIPT LANGUAGE=JAVASCRIPT SRC="http://services.postcodeanywhere.co.uk/popups/javascript.aspx?account_code=thewo11127&license_key=ug94-kz69-xz39-tm55"></SCRIPT>
